...
-- DropForeignKey
ALTER TABLE "RequestMatches" DROP CONSTRAINT "RequestMatches_pupilMatchRequestId_fkey";

-- DropForeignKey
ALTER TABLE "RequestMatches" DROP CONSTRAINT "RequestMatches_volunteerMatchRequestId_fkey";
